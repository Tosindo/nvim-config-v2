...
return {
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', ';tf', builtin.find_files, { desc = '[S]earch [F]iles' })
      vim.keymap.set('n', ';st', builtin.builtin, { desc = '[S]earch [S]elect Telescope' })
      ...
      vim.keymap.set('n', ';sr', builtin.oldfiles, { desc = '[S]earch Recent Files ("." for repeat)' })
